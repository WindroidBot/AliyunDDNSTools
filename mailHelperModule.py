...
def sendMessage(userConfigPath,messageStr):
    UserConfig = ReadConfig(userConfigPath, 'r')
    if UserConfig['remind']['enable'] == "true":
        logger.debug("UserConfig['remind']['enable'] value is : true ,should send message")
        logger.debug("The Message is :" + messageStr)
